...
public class FunctionLibrary {
		...
		public static WebDriver startBrowser()throws Throwable
		{
			...
			conpro.load(new FileInputStream("./properties.properties"));
		...
		public static void capturestock(String LocatorType,String LocatorValue) throws Throwable
		{
			...
			FileWriter fw = new FileWriter("D:\\Automation_selenium\\cucumber_framework\\CaptureData\\stockNumber.txt");
		...
		{
			FileReader fr = new FileReader("D:\\Automation_selenium\\cucumber_framework\\CaptureData\\stockNumber.txt");
		...
		public static void capturesupp(String LocatorType,String LocatorValue) throws Throwable
		{
			...
			FileWriter fw = new FileWriter("D:\\Automation_selenium\\cucumber_framework\\CaptureData\\suppliernum.txt");
			BufferedWriter bw = new BufferedWriter(fw);
		...
		public static void supplierTable() throws Throwable
		{
			...
			FileReader fr = new FileReader("D:\\Automation_selenium\\cucumber_framework\\CaptureData\\suppliernum.txt");
			BufferedReader br = new BufferedReader(fr);
			String Exp_Data =br.readLine();
			if(!driver.findElement(By.xpath(conpro.getProperty("search-textbox"))).isDisplayed())
				driver.findElement(By.xpath(conpro.getProperty("search-panel"))).click();
		...
		public static void captureCus(String LocatorType,String LocatorValue) throws Throwable
		{
			...
			FileWriter fw = new FileWriter("D:\\Automation_selenium\\cucumber_framework\\CaptureData\\customernum.txt");
			BufferedWriter bw = new BufferedWriter(fw);
		...
		public static void customerTable() throws Throwable
		{
			...
			FileReader fr = new FileReader("D:\\Automation_selenium\\cucumber_framework\\CaptureData\\customernum.txt");
			BufferedReader br = new BufferedReader(fr);
			String Exp_Data = br.readLine();
